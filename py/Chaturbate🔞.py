...
class Spider(Spider):
    ...
    categories = [
        ("女性", "female-cams"), ("情侣", "couple-cams"),  ("男性", "male-cams"), ("变性", "trans-cams"), ,
        ("亚洲", "asian-cams"), ("新人", "new-cams"),
        ("游戏", "gaming-cams"), ("熟女", "mature-cams"),
        ("北美", "north-american-cams"), ("南美", "south-american-cams"), ("欧洲/俄罗斯", "euro-russian-cams"),
